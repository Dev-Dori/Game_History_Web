...
def search_result(request):
    if request.method == "GET":
        ...
        game_list = {}
        game_list2 = []
        api_key = 'RGAPI-e792a26b-59dc-40dd-8647-ff2fd6a893cf'
        ...
        if res.status_code == requests.codes.ok:  # 결과값이 정상적으로 반환되었을때만 실행하도록 설정
            ...
            if summoners_result:
                ...
                tier_url = "https://kr.api.riotgames.com/lol/league/v4/entries/by-summoner/" + summoners_result[
                    'id']  # 소환사 티어 검색
        ...
        return render(request, 'score/search_result(1).html',
